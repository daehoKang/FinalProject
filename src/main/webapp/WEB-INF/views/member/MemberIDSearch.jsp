					    ...
					    <div class="row">
                            ...
                            <div class="p-5">
                                <div class="text-center">
                                    <h4 style="text-align:center; font-weight:bold;">아이디찾기</h4>
                                </div>

                                	 <form action="IdSearch" method="post" onsubmit="return IdSearch();" class="user">
                                    <div class="form-group" style="margin-bottom:0rem">
                                        <input type="email" name="mmail"  class="login_text_box"
                                            id="inputMmail" aria-describedby="emailHelp"
                                            placeholder="이메일을 입력하세요..." style="border-radius: 10px; margin-top:30px;">
                                ...
                                <p style="text-align:center; font-size:14px;">
                                		<a class="small" href="MemberPWSearch">비밀번호찾기</a>
                                </p>
